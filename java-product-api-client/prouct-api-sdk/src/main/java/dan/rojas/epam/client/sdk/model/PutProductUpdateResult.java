...
public class PutProductUpdateResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PutProductUpdateResult response(Response response) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutProductUpdateResult == false)
            return false;
        PutProductUpdateResult other = (PutProductUpdateResult) obj;
    ...
    @Override
    public PutProductUpdateResult clone() {
        try {
            return (PutProductUpdateResult) super.clone();
